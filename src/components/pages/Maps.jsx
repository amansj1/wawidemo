...
Geocode.setApiKey( "AIzaSyAwCayUe6qoDTOkg0Hq_esFNAOETgDHuVY" );
Geocode.enableDebug();
	...
	render(){
		...
		if( this.props.center.lat !== undefined ) {
			map = <div>
				...
				<AsyncMap
					googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyAwCayUe6qoDTOkg0Hq_esFNAOETgDHuVY&libraries=places"
					loadingElement={
